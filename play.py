...
def lines():
    speak(
        "Hello, Welcome to the Project Aarice. This is staged beta experience, Engine will be guiding you through out your experience. This project is underdevelopment by the CSE students of Jaypee University of Information Technology under the guidance of Dr. Aman Sharma. So without wasting any time Welcome to the Chess World. Enjoy your Experience.")
...
def main():
    ...
    ret += '<form action="/dev/" method="post"><button name="Comp Move" type="submit">Counter Bonk-E Move</button></form>'
    ret += '<form action="/engine/" method="post"><button name="Stockfish Move" type="submit">Make Stockfish Move</button></form>'
    ret += '<form action="/inst/" method="post"><button name="Instructions" type="submit">About Project Aarice</button></form>'
...
def cred():
    speak(
        "This Experience is underdevelopment by the CSE students of Jaypee University of Information Technology under the guidance of Dr. Aman Sharma. This Experience is still under the beta version.'")
    return main()
...
def inst():
    speak(
        "This engine is based on the work of Alpha-Prunning, Min-Max algorithm and Probabilistic datastructure for the improvement in the moves suggested. This project aims to provide the more reliable chess engine for the improved win probabilty. Though many of the milestones has not been achieved till now but the progress towrds those milestones has been initiated and it has been going productive till the date.")
    return main()
